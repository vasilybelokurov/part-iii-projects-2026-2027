...
Research-project descriptions offered by **Vasily Belokurov** (with Sergey Koposov) for
the Cambridge Part III / MASt in Astrophysics, 2026–27. Each project is a self-contained
`.docx` written to the departmental template.
...
```
.
├── 01_…docx … 05_…docx        # the five project descriptions
